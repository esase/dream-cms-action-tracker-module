 ...
 */
namespace ActionTracker\Form;

use Application\Form\ApplicationAbstractCustomForm;
use Application\Form\ApplicationCustomFormBuilder;
use ActionTracker\Model\ActionTrackerBase as ActionTrackerBaseModel;

class ActionTrackerFilter extends ApplicationAbstractCustomForm
{
    /**
     * Form name
     *
     ...
     * Model
     *
     * @var \ActionTracker\Model\ActionTrackerBase
     */
    protected $model;
     ...
     * Set model
     *
     * @param \ActionTracker\Model\ActionTrackerBase $model
     * @return \ActionTracker\Form\ActionTrackerFilter
     */
    public function setModel(ActionTrackerBaseModel $model)
    {
        $this->model = $model;
